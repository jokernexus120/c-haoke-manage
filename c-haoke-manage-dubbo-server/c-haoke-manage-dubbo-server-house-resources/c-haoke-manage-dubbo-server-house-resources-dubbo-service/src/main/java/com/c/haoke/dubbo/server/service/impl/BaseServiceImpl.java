...
import com.c.haoke.dubbo.server.mapper.HouseResourcesMapper;
import com.c.haoke.dubbo.server.pojo.BasePojo;
...
public abstract class BaseServiceImpl<T extends BasePojo>{
     ...
     * @return
     */
    public IPage<T> queryPageList( Integer page, Integer rows,
